...
from external_repos.yolov7 import test
from external_repos.yolov7.models.experimental import attempt_load
from external_repos.yolov7.models import Model
