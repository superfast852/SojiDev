...
def infer(image, context, bindings, binding_addrs):
    ...
    boxes = bindings['det_boxes'].data[0, :nums[0][0]]
    scores = bindings['det_scores'].data[0, :nums[0][0]]
    classes = bindings['det_classes'].data[0, :nums[0][0]]

    return nums, boxes, scores, classes
    #return nums, boxes, bindings['det_scores'].data, bindings['det_classes'].data
...
while True:
    ...
    #for i in range(dets.tolist()[0][0]):
